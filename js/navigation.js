...
var adminurl = "https://apiv2.smaaashusa.com/"; // url for India changed by Nargis-----to be uncommented
  ...
  .factory("NavigationService", function($http) {
    ...
    return {
      ...
      findProjects: function(
        ...
        $http
          .post(adminurl + apiName, pagination)
          .success(successCallback)
          .error(errorCallback);
      },
      findOneProject: function(
        apiName,
        urlParams,
        successCallback,
        errorCallback
        ...
        $http
          .post(adminurl + apiName, urlParams)
          .success(successCallback)
          .error(errorCallback);
      },
      getAssistance: function(
        ...
        $http
          .post(adminurl + "assistance/findLimited", urlParams)
          .success(successCallback)
          .error(errorCallback);
      },
